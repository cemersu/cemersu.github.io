...
![Linear Regression Equation Drawing](/assets/images/simplelr/equation-img.png)
...
![Slope Formula Drawing](/assets/images/simplelr/beta_1_img.png)

### 2. The Intercept (beta_0)
Once we have the slope, the line must pass through the average of our data points.

![Intercept Formula Drawing](/assets/images/simplelr/beta_0_img.png)
...
It views the world through a single lens (one x). But reality is rarely univariate. A house price isn't just about size; it’s about location, age, and room count. Predicting real-world phenomena with a simple line is like trying to solve a puzzle with missing pieces.
